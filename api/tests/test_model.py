...
#         print(validated)
#         assert ('error' in validated and validated['error']['msg'] == 'Make sure all required fields are submitted') is not True
...
def test_dir():
    assert os.path.exists('api/code/encoders')

def test_dir2():
    assert os.path.exists('/home/runner/work/backend/backend/api/code/encoders')